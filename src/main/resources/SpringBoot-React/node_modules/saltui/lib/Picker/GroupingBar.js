  ...
  _createClass(GroupingBar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: _Context2.default.prefixClass('picker-grouping-bar'),
        ...
        alphabet.map(function (key) {
          return _react2.default.createElement(
            'div',
            {
              className: (0, _classnames2.default)(_Context2.default.prefixClass('picker-group'), t.props.keys.indexOf(key) > -1 ? _Context2.default.prefixClass('picker-avilible-group') : null, t.state.holding === key ? _Context2.default.prefixClass('picker-active-group') : null),
              key: key,
              'data-key': key
            },
            key
        ...
        t.props.indicator ? _react2.default.createElement(
          'div',
          {
            className: (0, _classnames2.default)(_Context2.default.prefixClass('picker-grouping-indicator'), t.state.holding ? null : _Context2.default.prefixClass('picker-grouping-indicator-hide'), t.props.keys.indexOf(t.state.holding) > -1 ? _Context2.default.prefixClass('picker-avilible-group') : null),
