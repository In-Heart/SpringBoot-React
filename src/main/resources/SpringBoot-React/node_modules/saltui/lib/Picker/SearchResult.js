...
var SearchResult = function (_React$Component) {
  ...
  _createClass(SearchResult, [{
    ...
    value: function renderResultItem(item, index) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          { className: _Context2.default.prefixClass('picker-search-result-item-entry picker-right-icon') },
          t.props.formatter(item)
        ),
        _react2.default.createElement(
          'span',
          { className: _Context2.default.prefixClass('picker-search-result-item-icon picker-right-icon') },
          iconHTML
        )
      );
    }
    ...
    value: function render() {
      ...
      var locale = t.props.locale;
      var length = this.state.value.length;

      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)(_Context2.default.prefixClass('picker-searchpanel'), 'multiple'),
          style: {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: _Context2.default.prefixClass('picker-searchpanel-head-bar') },
            _react2.default.createElement(
              'div',
              { className: _Context2.default.prefixClass('picker-searchpanel-head-bar-total') },
              _i18n2.default[locale].selected(length)
            ),
            _react2.default.createElement(
              'div',
              {
                className: _Context2.default.prefixClass('picker-searchpanel-head-bar-button'),
                onClick: function onClick(e) {
                  t.handleConfirm(e);
                }
              },
              _i18n2.default[locale].complete
            )
          ),
          _react2.default.createElement(
            'div',
